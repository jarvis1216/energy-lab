...
// 优先使用环境变量，便于迁移到 Next.js / Vercel；本地静态部署则回退到硬编码配置
const SUPABASE_URL      = (typeof process !== 'undefined' && process.env?.NEXT_PUBLIC_SUPABASE_URL)      || 'https://tkuyzjvuvqfpulalineh.supabase.co';
const SUPABASE_ANON_KEY = (typeof process !== 'undefined' && process.env?.NEXT_PUBLIC_SUPABASE_ANON_KEY) || 'sb_publishable_Eb2lzvEst0QX4iX9PakHwQ_bsHO660D';
